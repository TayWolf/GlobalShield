            ...
            <form method="POST" action="<?=base_url()?>">
                <div class="col s12">
                    ...
                    <div class="input-field col s12" style="display:flex;">
                        <div class="input-field col s12">
                            <p class="center-align"><strong>Su correo fué verificado exitosamente</strong></p>
                        </div>
                ...
                <div class="row">
                    <div class="input-field col s12" align="center">
                        <input type="submit" class="btn waves-effect waves-light" value="Ingresar al sistema">
                    </div>
                </div>
            </form>
        </div>
