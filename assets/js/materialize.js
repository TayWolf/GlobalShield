...
;(function ($) {
            ...
            return this.each(function () {
                ...
                if(!$.isEmptyObject(data)) {
                    ...
                    $autocomplete.on('click', 'li', function () {
                        ...
                        $input.trigger('change');
                        console.log("Ejecutando la función establecerAutocomplete("+$input.data('id')+", autocompleteElement);");
                        establecerAutocomplete($input.data('id'), $input);
                        $autocomplete.empty();
                    });
                }
            });
    ...
    $.fn.material_select = function (callback) {
        $(this).each(function () {
            var $select = $(this);
/*
            //Se agregó este código porque el select de materialize no funciona en chrome.
            var isChrome = !!window.chrome && (!!window.chrome.webstore || !!window.chrome.runtime);

            if(isChrome)
            {
                $select.parent().removeClass("input-field");
                $select.addClass('browser-default');
                var $parent=$select.parent();
                var $selectBackup=$select;
                $select.remove();
                $parent.append($selectBackup);
            }
            //Fin del código del select en chrome*/
